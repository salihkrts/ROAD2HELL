...
const tr_part1 = {
    ...
    werewolf_bozkir_d6: {
      ...
      medium: [
          ...
          choices: [
            { 
              ...
              followUp: {
                ...
                choices: [
                  { 
                    text: "Bunu sormak benim görevim. Kim açtı?", 
                    effect: +15, 
                    next: "Hırıltılı bir nefes alıyor. 'Bir kadın. Siyah kıyafetli. Gözleri sisin kendisi gibi griydi. Ve onunla çalışan... yaşlı bir kadın daha vardı.'",
                    followUp: {
                      text: "Sırtını dönüp omuzlarındaki devasa, morarmış pençe ve kimyasal yanık izlerini gösteriyor. 'Bu yaraları görüyor musun? Bunlar sise ilk maruz kaldığımda, Sektör-0'dan kaçarken oldu. O gri gözlü kadın arkamdan gümüş kurşunlar ve zehirli gazlar attı. Sisin içindeki o ilk deneyimim... Hücrelerimin eridiğini, etimin yeniden bir canavar gibi birleştiğini hissettim. O acıyı tarif edemem asker. Her saniye kemiklerimin kırılıp yeniden uzamasını hissettim.'",
                      choices: [
                        {
                          text: "Nasıl hayatta kalabildin bu mutasyondan?",
                          effect: +18,
                          next: "Derin bir hırıltıyla göğsüne vuruyor. 'İçimdeki vahşi irade sayesinde. Çoğu insan ilk beş dakikada bilincini kaybedip sise teslim olur. Ben acıyı bir silah gibi kullandım. Bedenim bir daha asla eskisi gibi olmadı.'",
                          followUp: {
                            text: "Tekrar sana dönüyor. 'Yaralarım iyileşmiyor. Sis her yoğunlaştığında bu izler kor gibi yanıyor. Sanki dışarıdaki o lanet gaz, hücrelerimdeki canavarı dışarı çağırıyor gibi. Bazen... aynada kendime baktığımda insandan geriye ne kaldığını sorguluyorum.'",
                            choices: [
                              {
                                text: "H�l� i�eride bir insan var Bozk1r, bunu ben g�r�yorum.",
                                effect: +20,
                                next: "G�zlerindeki k1rm1z1 parlama bir anl11na hafifliyor. 'Bunu duymak... uzun zamand1r duyduum en insani _ey asker. Te_ekk�r ederim.'",
                                followUp: {
                                  text: "Derin bir i� �ekiyor. 'Sisin i�inde kaybolduum o ilk saatlerde, bilincim tamamen karanl1a teslim olmak �zereydi. Ama zihnimde hep ayn1 an1 d�n�p duruyordu: K1z1m1n doum g�n�, pastan1n mumlar1n1 �flerken �1kard11 o ince ne_eli ses... Sisin souk pen�eleri ruhumu s�kmeye �al1_1rken ben o sese sar1ld1m. Sisin i�indeki mutasyon sadece bedenimi bozmad1 asker, ruhumu da s�rekli �iniyor. G�zlerimi kapatt11mda o gri sisin bana f1s1ldad11n1 duyuyorum. Sana da f1s1ld1yor mu?'",
                                  choices: [
                                    {
                                      text: "Bana ne f1s1ld1yor Bozk1r?",
                                      effect: +15,
                                      next: "'B1rak diyor... Sava_1 b1rak, ac1y1 b1rak, teslim ol ve sisin huzuruna kar1_... Bunu o kadar tatl1 f1s1ld1yor ki, insan bir anl11na her _eyden vazge�mek istiyor. Ama uyanmal1 ve direnmeliyiz. Eer pes edersek, bizi insan yapan her _eyi kaybederiz. Yaralar1m1n s1zlamas1 bana hala hayatta olduumu ve hala sava_acak bir _eylerim olduunu hat1rlat1yor.'"
                                    },
                                    {
                                      text: "Ben sisin f1s1lt1lar1n1 duymuyorum, zihnim �elik gibi.",
                                      effect: +10,
                                      next: "'G�zel. �elik irade bu d�nyada en b�y�k kalkan1nd1r. Ama dikkat et, sis �elii bile pasland1r1r. Zihnini koru asker. Eer bir g�n zay1flad11n1 hissedersen, buraya gel. Sana o f1s1lt1lara kar_1 nas1l k�kreyeceini �retirim.'"
                                    }
                                  ]
                                }
                              },
                              {
                                text: "Sadece hayatta kalmaya odaklanmalıyız.",
                                effect: +10,
                                next: "'Doğru söylüyorsun. Duygusallık sığınakta lükstür. Sadece dişlerim ve pençelerim işe yarayacak.'"
                              }
                            ]
                          }
                        },
                        {
                          text: "Gri gözlü kadının amacı neydi sence?",
                          effect: +15,
                          next: "'Bizi dönüştürmek. Sisle uyumlu, acı hissetmeyen ve emirleri sorgulamayan bir ordu yaratmak istiyorlardı. Ben onların ilk başarılı kaçak deneyiyim.'",
                          followUp: {
                            text: "Fısıldayarak devam ediyor: 'O tünellerin derinliklerinde, sise dirençli hale getirilen bazı deneklerin kanının saklandığı bir kasa odası vardı. Eğer o kasayı bulabilirsek, Doktor Arzu belki bu mutasyonu durduracak bir serum üretebilir. Ama oraya gitmek intihar demektir.'",
                            choices: [
                              {
                                text: "O kasayı bulmak için canımı tehlikeye atarım.",
                                effect: +25,
                                next: "Pençesini omzuna koyuyor, canını acıtmayacak kadar hafifçe. 'Cesurca ama aptalca. Yine de, eğer gidersen... tırnaklarımla kazıdığım haritayı aklında tut. Kuzey deposunun hemen altında.'"
                              },
                              {
                                text: "Bu işi doktorla konuşup planlamalıyız.",
                                effect: +15,
                                next: "'En doğrusu. Arzu akıllı kadındır. O tünellerin tehliğini en iyi o bilir.'"
                              }
                            ]
                          }
                        }
                  ...
                  { 
                    text: "Komplo teorileriyle uğraşacak vaktim yok.", 
                    effect: -10, 
                    next: "'Vaktin kalmadığında tırnaklarımın seni nasıl uyardığını hatırlarsın. Git şimdi.'" 
                  }
                ]
              }
            },
        ...
        {
          text: "Kızım... adını söylesem de bilmez artık. Sis gelmeden önceki ben bir babaydı. Şimdi ne olduğumu, bu tüylü ve vahşi görünüşümle onun karşısına çıksam beni tanıyıp tanımayacağını bilmiyorum asker.",
          choices: [
            { 
              text: "Hâlâ o babasın Bozkır. Değişmedi bu.", 
              effect: +20, 
              next: "Sesi kısılıyor. Pençesi taş duvara yaslanıyor yavaşça. 'Onu en son gördüğümde beş yaşındaydı. Gözleri tıpkı benim eski gözlerim gibiydi... kahverengi, içi gülen gözler.'",
              followUp: {
                text: "Gözlerini kapatıp geçmişi hatırlar gibi yapıyor. 'Sis şehri yutmaya başladığında onu sığınağa götüren konvoyun peşinden koştum. Ama yolda dönüştüm... Beni gören askerler ateş açtı, kızımın koruyucuları beni bir canavar sanıp benden kaçırdı onu. Kendi kızımı kurtarmaya çalışırken onun gözlerinde gördüğüm o dehşet dolu bakış... İşte bu yaralardan daha çok acıtıyor asker. Beni bir canavar sandı.'",
                choices: [
                  {
                    text: "Korkmuştu, ne olduğunu anlayamadı. Seni suçlamaz.",
                    effect: +22,
                    next: "Derin bir nefes alıyor, omuzları çöküyor. 'Umarım öyledir. Eğer yaşıyorsa, şimdi on yaşında olmalı. Onu bulacağıma dair kendime söz verdim. Ama bu canavar haliyle onu bulsam ne yapacağım?'",
                    followUp: {
                      text: "Sana doğru bir adım atıyor. 'Bana yardım edebilir misin asker? Eğer diğer sektörlerden haber alırsan, adını araştırır mısın? Adı Selin. Selin Bozkurt. Benim eski soyadım... Canavar olmadan önceki soyadım.'",
                      choices: [
                        {
                          text: "S�z veriyorum Bozk1r, Selin'i bulmak i�in her yolu deneyeceim.",
                          effect: +25,
                          next: "Sana minnettar bir bak1_ at1yor. 'Bu s�z... bu s11naktaki t�m g�m�_lerden daha deerli benim i�in. Te_ekk�r ederim asker.'",
                          followUp: {
                            text: "Bozk1r g�zlerini sana doru �eviriyor, sesinde nadir g�r�len bir yumu_akl1k var. 'Eer onu bulursan... ona vermeni istediim bir _ey var.' Pen�esini s1rt1ndaki k���k, y1rt1k bir cebe at1yor ve oradan pirin�ten yap1lm1_, kenarlar1 a_1nm1_ eski bir k�stekli saat �1kar1yor. 'Bu babamdan kalm1_t1. Arkas1nda k���k bir �izik var, Selin'le birlikte o �izii t1rna1m1zla yapm1_t1k. Ona bunu ver ve de ki: \"Baban hala n�bette. Sisin i�inde olsa bile seni koruyor.\" Sence bunu ona ula_t1rabilir misin asker?'",
                            choices: [
                              {
                                text: "Bu saati alaca1m ve ne pahas1na olursa olsun ona ula_t1raca1m.",
                                effect: +25,
                                next: "'Sana minnettar1m. Art1k �lsem de g�z�m arkada kalmaz. Bu saat benim insanl11mdan geriye kalan son par�a. Onu sana emanet ediyorum.'",
                                followUp: {
                                  text: "Saati sana uzat1rken elleri titriyor. 'Selin �ok ak1ll1 bir �ocuktur. Eer ya_1yorsa, muhtemelen dier s11naklardaki �ocuklara yard1m ediyordur. Resim yapmay1 �ok severdi. �zellikle de g�ky�z�n�... G�ky�z�n�n mavi olduu zamanlar1 hat1rlayan son nesil onlar. Sence bir g�n g�ky�z� yeniden mavi olacak m1 asker, yoksa sonsuza dek bu gri lanete mi mahkumuz?'",
                                  choices: [
                                    {
                                      text: "Bir g�n sisi tamamen da1taca1z, g�ky�z� yeniden mavi olacak.",
                                      effect: +20,
                                      next: "'Umut... 0�imi 1s1t1yor bu s�zler. Eer o g�n� g�remezsem bile Selin'in o mavilii g�rmesi i�in son nefesime kadar kap1y1 savunaca1m.'"
                                    },
                                    {
                                      text: "Ger�ek�i olmal1y1z Bozk1r, bu sis kal1c1 gibi g�r�n�yor.",
                                      effect: +5,
                                      next: "'Ac1 ama ger�ek�i bir bak1_ a�1s1. Yine de... Selin'in hayallerini korumak i�in yalanlara sar1lmak gerekse bile sar1laca1m. Sava_mak i�in bir yalana ihtiyac1m varsa, vars1n �yle olsun.'"
                                    }
                                  ]
                                }
                              },
                              {
                                text: "Saati bende tutamam, ama onu bulduumda senin ad1na konu_aca1m.",
                                effect: +10,
                                next: "'Bu da yeterli asker. Sadece ad1m1 bilsin, onu unutmad11m1 bilsin yeter.'"
                              }
                            ]
                          }
                        },
                        {
                          text: "Eğer hayattaysa mutlaka bir yerlerde izi vardır, bakarız.",
                          effect: +12,
                          next: "'Buna da şükür. En azından tamamen unutulmayacak.'"
                        }
                      ]
                    }
                  },
                  {
                    text: "Kızını bulduğumuzda seni bu halinle kabullenecektir.",
                    effect: +15,
                    next: "'Çocuklar saf sevgiyle bakar derler. Umarım o sis onun da kalbini karartmamıştır.'"
                  }
                ]
              }
            },
            { 
              text: "Kızın nerede şimdi?", 
              effect: +10, 
              next: "'Bilmiyorum. Sektör-5 tahliyesinde kayboldu. Belki başka bir sığınaktadır. Belki de... sise teslim olmuştur.' Gözleri doluyor.",
              followUp: {
                text: "'Eğer sise teslim olduysa... Vera'nın kölelerinden biri olmuş demektir. Onu o halde görürsem, kendi ellerimle acısına son vermek zorunda kalırım. Bir babanın yaşayabileceği en büyük ceza bu olurdu asker.'",
                choices: [
                  {
                    text: "Böyle düşünme, ümidini kaybetme.",
                    effect: +12,
                    next: "'Ümit... bu dünyada en son ölen şeydir. Ama burada ölüm çok hızlı.'"
                  },
                  {
                    text: "Öyle bir durum olursa ne yapacağını biliyorsun.",
                    effect: -5,
                    next: "Homurdanıyor. 'Bilmek başka, yapabilmek başka asker.'"
                  }
                ]
              }
            },
            { text: "Geçmiş geçmişte kaldı.", effect: -10, next: "Sert bir bakış. 'Senin için belki. Ama benim geçmişim hâlâ bu pençelerde atıyor.'" }
          ]
        }
      ],
      high: [
        {
          text: "Seninle bir şey paylaşacağım. Bunu kimseye söylemedim. Söylemek zorundayım.",
          isSpecial: true,
          choices: [
            { text: "Dinliyorum.", effect: +20, next: "'Sis... bazılarını seçiyor. Rastgele değil. Ben bunu hissediyorum kokulardan. Seçilenlerin kokusu değişiyor. Sen bu kokuyu taşımıyorsun. Ama içeride taşıyanlar var.' Gözleri doğrudan gözüne kilitleniyor." },
          ...
          choices: [
            { 
              ...
              followUp: {
                ...
                choices: [
                  {
                    text: "Sekt�r-3'�n alt1 m1? Oray1 Salih de bahsetmi_ti.",
                    effect: +15,
                    next: "'Salih mi? O ya_l1 kurt �ok _ey biliyor. Eer o da oray1 g�steriyorsa, doru yolday1z demektir.'",
                    followUp: {
                      text: "Arzu �enesini s1vazl1yor. 'Sekt�r-3'�n alt1ndaki o laboratuvar s1radan bir t1bbi depo deil. Sisin ilk yay1lmaya ba_lad11 yer oras1yd1. Proje S1f1r orada ba_lad1. O t�nellerin derinliklerinde ne t�r s1rlar sakland11n1 tahmin bile edemezsin. Deney kay1tlar1, ilk mutasyon �rnekleri... Hatta belki de sisin kayna1n1 tamamen yok edecek bir form�l. Oraya gitmeye cesaretin var m1 asker?'",
                      choices: [
                        {
                          text: "Sekt�r-7 ve t�m insanl1k i�in oraya ineceim. Ne yapmam gerekiyor?",
                          effect: +20,
                          next: "'Bu cesaretin beni duyguland1r1yor. Sana laboratuvar1n giri_ kart1n1 vereceim. Y1llar �nce bir meslekta_1m ka�arken bana b1rakm1_t1. Ama unutma, o laboratuvar1n koridorlar1nda sise maruz kalm1_ ve tamamen canavara d�n�_m�_ eski personel olabilir.'",
                          followUp: {
                            text: "G�zlerini kapat1p derin bir nefes al1yor. 'O meslekta_1m1n ad1 Leyla'yd1. Laboratuvar s1zd11nda kendini i�eri kilitledi. Eer orada onun bedenini veya g�nl��n� bulursan... L�tfen onu huzura kavu_tur ve g�nl�� bana getir. Bu benim i�in ki_isel bir bor�. Bunu yapabilir misin?'",
                            choices: [
                              {
                                text: "S�z veriyorum Arzu, Leyla'y1 bulup g�nl��n� sana getireceim.",
                                effect: +25,
                                next: "'Te_ekk�r ederim asker. Bu bilgi ve senin iraden, bu karanl1k �ada sahip olduumuz tek ger�ek 1_1k. Kendine dikkat et.'"
                              },
                              {
                                text: "�nceliim sadece t1bbi malzemeler ve �rnekler olacak.",
                                effect: +10,
                                next: "'Bunu da anl1yorum. Hayatta kalmak �nceliktir. Ama Leyla'n1n hat1ras1... Neyse, sen yine de g�z�n� a�1k tut.'"
                              }
                            ]
                          }
                        },
                        {
                          text: "^u anki savunmam1za odaklanmal1y1z, a_a1s1 intihar demek.",
                          effect: +5,
                          next: "'Belki de hakl1s1n. Ama duvarlar1n arkas1nda beklemek de bizi sadece yava_ yava_ �l�me g�t�r�r. Yine de karar1na sayg1 duyuyorum.'"
                        }
                      ]
                    }
                  },
          ...
          choices: [
            { 
              ...
              followUp: {
                ...
                choices: [
                  {
                    text: "Sana g�venli bir alan salayaca1m.",
                    effect: +15,
                    next: "'Te_ekk�r ederim. Sana g�venebileceimi biliyordum. Selim'in g�zlerindeki 1_1k s�nmemeli.'",
                    followUp: {
                      text: "F1s1ldayarak devam ediyor: 'S11nak sakinlerinden baz1lar1 da durumun fark1nda. Bozk1r mesela... Onun mutasyonu sise kar_1 inan1lmaz bir diren� geli_tirmi_. Onun kan �rneklerini de incelemek istiyorum ama benden ka�1yor. Canavar gibi g�r�nmekten utan1yor ve revire girmeyi reddediyor. Eer onunla konu_up bana yard1m etmesini salayabilirsen, belki de mutasyonu tamamen geri �evirebilecek bir tedavi bulabiliriz. Bozk1r'1 ikna edebilir misin?'",
                      choices: [
                        {
                          text: "Bozk1r'la konu_up onu ikna etmeye �al1_aca1m.",
                          effect: +20,
                          next: "'Harika! O sana g�veniyor, bunu g�rebiliyorum. Onun kan1 ve Selim'in h�creleri bir araya gelirse, sis mutasyonuna kar_1 nihai bir kalkan �retebiliriz. Bu insanl11n geri d�n�_ bileti olabilir.'",
                          followUp: {
                            text: "Arzu yava_�a elini omzuna koyuyor. 'Peki ya sen asker? Herkesi kurtarmaya �al1_1rken kendi zihnini nas1l koruyorsun? Sisin senin �zerinde de etkileri olduunu biliyorum. G�zlerindeki o yorgunluk... Bazen senin i�in de endi_eleniyorum. Kendine bir _ey olmas1na izin verme, tamam m1?'",
                            choices: [
                              {
                                text: "Benim i�in endi_elenme Arzu, bu sekt�r� korumak benim tek amac1m.",
                                effect: +15,
                                next: "'Biliyorum ama kahramanlar da insand1r. Sana bir doz n�ro-sakinle_tirici yaz1yorum. 0htiyac1n olduunda kullan. Hayatta kalmana ihtiyac1m1z var.'"
                              },
                              {
                                text: "Bazen zihnimin buland11n1 hissediyorum, ama dayanmak zorunday1m.",
                                effect: +22,
                                next: "'Bu d�r�stl��n �ok deerli. Sis zihnin zay1f anlar1n1 kollar. Sana �zel bir ar1nd1r1c1 serum haz1rlayaca1m. Zihnini berrak tutacakt1r. Yaln1z deilsin, bunu unutma.'"
                              }
                            ]
                          }
                        },
                        {
                          text: "Bozk1r'1 zorlamak istemiyorum, o zaten yeterince ac1 �ekiyor.",
                          effect: +10,
                          next: "'Hakl1s1n, ona sayg1 duymal1y1z. Ama eer kendi isteiyle gelirse kap1m1z her zaman a�1k. Onun ac1s1n1 dindirmek benim de en b�y�k isteim.'"
                        }
                      ]
                    }
                  },
    ...
    werewolf_bozkir_d6: {
      ...
      medium: [
                      ...
                      choices: [
                        {
                          ...
                          followUp: {
                            ...
                            choices: [
                              {
                                text: "There is still a human inside, Bozk1r. I can see it.",
                                effect: +20,
                                ...
                                followUp: {
                                  ...
                                  choices: [
                                    {
                                      text: "What does it whisper to you, Bozk1r?",
                                      effect: +15,
        ...
        },
        {
          ...
          choices: [
            { 
              text: "You are still that father, Bozkır. That hasn't mutated.", 
              effect: +20, 
                            ...
                            choices: [
                              {
                                ...
                                followUp: {
                                  ...
                                  choices: [
                                    ...
                                    {
                                      text: "We must be realistic, Bozk1r. This Mist seems permanent.",
                                      effect: +5,
      ...
      high: [
        {
          ...
          choices: [
            { 
              ...
              followUp: {
                text: "She continues in a whisper: 'Some of the shelter residents are also aware of the situation. Bozk1r, for instance... His mutation has developed an incredible resistance to the Mist. I want to analyze his blood samples as well, but he avoids me. He is ashamed of looking like a monster and refuses to enter the Med-Bay. If you can talk to him and get him to help me, perhaps we can find a cure to completely reverse the mutation. Can you convince Bozk1r?'",
                choices: [
                  {
                    text: "I'll talk to Bozk1r and try to convince him.",
                    effect: +20,
                  ...
                  {
                    text: "I don't want to force Bozk1r, he is already suffering enough.",
                    effect: +10,
